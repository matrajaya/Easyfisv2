...
namespace easyfis.Controllers
{
    public class ApiJournalController : ApiController
    {
        ...
        // list journal by ArticleId and AccountId for Journal Ledgers
        [Authorize]
        [HttpGet]
        [Route("api/journal/list/journalLedger/byAccountId/{accountId}/byArticleId/{articleId}")]
        public List<Models.TrnJournal> listJournalLedgerByAccountIdAndByArticleId(String accountId, String articleId)
        {
            var journals = from d in db.TrnJournals
