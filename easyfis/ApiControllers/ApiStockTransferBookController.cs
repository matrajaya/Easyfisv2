...
namespace easyfis.ApiControllers
{
    public class ApiStockTransferBookController : ApiController
    {
        ...
        [Authorize]
        [HttpGet]
        [Route("api/StockTransferBook/list/{startDate}/{endDate}/{companyId}")]
        public List<Models.TrnJournal> listStockTransferBook(String startDate, String endDate, String companyId)
        {
