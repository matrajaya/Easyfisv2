...
namespace easyfis.Data
{
	...
	public partial class MstArticleGroup : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<MstArticleGroup> _MstArticleGroup2;
		...
		private EntityRef<MstArticleGroup> _MstArticleGroup1;
    ...
    partial void OnUpdatedDateTimeChanged();
		...
		{
			this._MstArticles = new EntitySet<MstArticle>(new Action<MstArticle>(this.attach_MstArticles), new Action<MstArticle>(this.detach_MstArticles));
			this._MstArticleGroup2 = default(EntityRef<MstArticleGroup>);
			this._MstAccount = default(EntityRef<MstAccount>);
			this._MstAccount1 = default(EntityRef<MstAccount>);
			this._MstAccount2 = default(EntityRef<MstAccount>);
			this._MstAccount3 = default(EntityRef<MstAccount>);
			this._MstAccount4 = default(EntityRef<MstAccount>);
			this._MstArticleGroup1 = default(EntityRef<MstArticleGroup>);
			this._MstArticleType = default(EntityRef<MstArticleType>);
			this._MstUser = default(EntityRef<MstUser>);
			this._MstUser1 = default(EntityRef<MstUser>);
			OnCreated();
		...
		public int Id
		{
			...
			set
			{
				if ((this._Id != value))
				{
					if (this._MstArticleGroup1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnIdChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MstArticleGroup_MstArticleGroup", Storage="_MstArticleGroup2", ThisKey="Id", OtherKey="Id", IsUnique=true, IsForeignKey=false)]
		public MstArticleGroup MstArticleGroup2
		{
			get
			{
				return this._MstArticleGroup2.Entity;
			}
			set
			{
				MstArticleGroup previousValue = this._MstArticleGroup2.Entity;
				if (((previousValue != value) 
							|| (this._MstArticleGroup2.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._MstArticleGroup2.Entity = null;
						previousValue.MstArticleGroup1 = null;
					}
					this._MstArticleGroup2.Entity = value;
					if ((value != null))
					{
						value.MstArticleGroup1 = this;
					}
					this.SendPropertyChanged("MstArticleGroup2");
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MstArticleGroup_MstArticleGroup", Storage="_MstArticleGroup1", ThisKey="Id", OtherKey="Id", IsForeignKey=true)]
		public MstArticleGroup MstArticleGroup1
		{
			get
			{
				return this._MstArticleGroup1.Entity;
			}
			set
			{
				MstArticleGroup previousValue = this._MstArticleGroup1.Entity;
				if (((previousValue != value) 
							|| (this._MstArticleGroup1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._MstArticleGroup1.Entity = null;
						previousValue.MstArticleGroup2 = null;
					}
					this._MstArticleGroup1.Entity = value;
					if ((value != null))
					{
						value.MstArticleGroup2 = this;
						this._Id = value.Id;
					}
					else
					{
					...
					this.SendPropertyChanged("MstArticleGroup1");
				}
			}
		}
