...
{
    public class RepStockOutBookController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // ===========================
        // Stock Out Book Report - PDF
        // ===========================
        [Authorize]
        public ActionResult StockOutBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Stock-Out Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
