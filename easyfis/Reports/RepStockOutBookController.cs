...
namespace easyfis.Reports
{
    public class RepStockOutBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult StockOutBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Stock-Out Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
