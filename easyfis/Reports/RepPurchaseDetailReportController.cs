    ...
    public class RepPurchaseDetailReportController : Controller
    {
        ...
        public ActionResult PurchaseDetailReport(String StartDate, String EndDate, String CompanyId, String BranchId)
        {
            ...
            if (purchaseOrderItems.Any())
            {
                ...
                float[] widthsCellsData = new float[] { 20f, 15f, 13f, 25f, 25f, 15f, 10f, 15f, 15f };
                ...
                {
                    data.AddCell(new PdfPCell(new Phrase(purchaseOrderItem.Branch, fontArial10)) { HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = 5f, PaddingRight = 5f, PaddingLeft = 5f });
                    ...
                    data.AddCell(new PdfPCell(new Phrase(purchaseOrderItem.Price.ToString("#,##0.00"), fontArial10)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 5f, PaddingRight = 5f, PaddingLeft = 5f });
