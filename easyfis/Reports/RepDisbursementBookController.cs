...
namespace easyfis.Reports
{
    public class RepDisbursementBookController : Controller
    {
        ...
        // ==============================
        // Disbursement Book Report - PDF
        // ==============================
        [Authorize]
        public ActionResult DisbursementBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Disbursement Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
