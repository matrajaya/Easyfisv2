...
{
    public class RepSalesBookController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // =======================
        // Sales Book Report - PDF
        // =======================
        [Authorize]
        public ActionResult SalesBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Sales Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
