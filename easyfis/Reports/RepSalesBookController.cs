...
namespace easyfis.Reports
{
    public class RepSalesBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult SalesBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Sales Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
