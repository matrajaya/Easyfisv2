        ...
        public ActionResult CashFlowIndirect(String StartDate, String EndDate, Int32 CompanyId)
        {
            ...
            if (unionCashFlows.Any())
            {
                ...
                foreach (var unionCashFlow in unionCashFlows)
                {
                    ...
                    float[] widthCellsTableCashFlow = new float[] { 50f, 150f, 30f };
                    ...
                    if (unionAccountTypes.Any())
                    {
                        ...
                        foreach (var unionAccountType in unionAccountTypes)
                        {
                            ...
                            float[] widthCellsTableAccountType = new float[] { 50f, 150f, 30f };
                            ...
                            if (unionAccountGroups.Any())
                            {
                                foreach (var unionAccountGroup in unionAccountGroups)
                                {
                                    ...
                                    float[] widthCellsTableAccount = new float[] { 50f, 150f, 30f };
                        ...
                        PdfPTable tableTotalCashFlow = new PdfPTable(3);
                        float[] widthCellsTableTotalCashFlow = new float[] { 50f, 150f, 30f };
                ...
                float[] widthCellsTableCashFlowTotalAllBranches = new float[] { 50f, 150f, 30f };
