...
{
    public class RepJournalVoucherBookController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // =================================
        // Journal Voucher Book Report - PDF
        // =================================
        [Authorize]
        public ActionResult JournalVoucherBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Journal Voucher Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
