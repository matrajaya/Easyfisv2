...
namespace easyfis.Reports
{
    public class RepJournalVoucherBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult JournalVoucherBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Journal Voucher Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
