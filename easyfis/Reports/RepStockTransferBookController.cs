...
{
    public class RepStockTransferBookController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // ================================
        // Stock Transfer Book Report - PDF
        // ================================
        [Authorize]
        public ActionResult StockTransferBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Stock Transfer Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
