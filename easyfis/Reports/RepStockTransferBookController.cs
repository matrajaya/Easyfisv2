...
namespace easyfis.Reports
{
    public class RepStockTransferBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult StockTransferBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Stock-Transfer Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
