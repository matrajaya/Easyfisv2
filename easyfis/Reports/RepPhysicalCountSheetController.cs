...
{
    public class RepPhysicalCountSheetController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // =================================
        // Physical Count Sheet Report - PDF
        // =================================
        [Authorize]
        public ActionResult PhysicalCountSheet(Int32 ItemGroupId)
        {
            // ==============================
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Physical Count Sheet", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
            ...
            if (items.Any())
            {
                ...
                if (articleGroups.Any())
                {
                    ...
                    float[] widthscellsTableTtems = new float[] { 15f, 20f, 35f, 25f, 20f };
                    ...
                    foreach (var item in items)
                    {
                        ...
                        tableItems.AddCell(new PdfPCell(new Phrase(" ", fontArial10)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                    }
