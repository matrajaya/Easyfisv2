...
namespace easyfis.Reports
{
    public class RepPhysicalCountSheetController : Controller
    {
        ...
        public ActionResult PhysicalCountSheet(Int32 ItemGroupId)
        {
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Physical Count Sheet", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
            ...
            foreach (var itemGroup in itemGroups)
            {
                ...
                if (items.Any())
                {
                    ...
                    tableItemGroup.AddCell(new PdfPCell(new Phrase(itemGroup.ArticleGroup, fontArial10Bold)) { Border = 0, HorizontalAlignment = 0, PaddingTop = 10f, PaddingBottom = 9f });
