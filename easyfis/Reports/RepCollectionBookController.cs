...
namespace easyfis.Reports
{
    public class RepCollectionBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult CollectionBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Collection Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
