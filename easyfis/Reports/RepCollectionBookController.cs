...
{
    public class RepCollectionBookController : Controller
    {
        // ============
        // Data Context
        // ============
        ...
        // ============================
        // Collection Book Report - PDF
        // ============================
        [Authorize]
        public ActionResult CollectionBook(String StartDate, String EndDate, Int32 CompanyId, Int32 BranchId)
        {
            // ============
            // PDF Settings
            // ============
            ...
            headerPage.AddCell(new PdfPCell(new Phrase("Collection Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
