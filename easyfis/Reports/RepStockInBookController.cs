...
namespace easyfis.Reports
{
    public class RepStockInBookController : Controller
    {
        ...
        [Authorize]
        public ActionResult StockInBook(String StartDate, String EndDate, Int32 CompanyId)
        {
            // PDF settings
            ...
            tableHeaderPage.AddCell(new PdfPCell(new Phrase("Stock-In Book", fontArial17Bold)) { Border = 0, HorizontalAlignment = 2 });
